...
An image will be broken up into smaller pieces, which must then be dragged and dropped onto the correct location on a grid of squares.

![alt text](jigsaw-puzzle.png "Jigsaw Puzzle")
